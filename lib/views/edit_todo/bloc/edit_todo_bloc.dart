...
/// {@template edit_todo_bloc}
/// A Bloc responsible for managing the editing of a todo item.
/// {@endtemplate}
class EditTodoBloc extends Bloc<EditTodoEvent, EditTodoState> {
  /// {@macro edit_todo_bloc}
  EditTodoBloc({
    ...
    on<EditTodoDueTimeChanged>(_onDueTimeChanged);
